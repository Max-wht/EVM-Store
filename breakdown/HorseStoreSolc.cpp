...
//@note 0x46 [updateHorseNumber_index_1_9]
JUMPDEST
PUSH1 0x66
JUMP

//@note 0x4a [updateHorseNumber_index_1_11]
JUMPDEST
STOP
...
//@note 0x66 [updateHorseNumber_index_1_10]
JUMPDEST
DUP1
PUSH0
DUP2
...
//@note: 0x7b [updateHorseNumber_index_1_4]
JUMPDEST
PUSH0
DUP2
SWAP1
...
//@note 0x84 [updateHorseNumber_index_1_3]
JUMPDEST
PUSH1 0x8b
DUP2
PUSH1 0x7b
...
//@note 0x8b [updateHorseNumber_index_1_5]
JUMPDEST
DUP2
EQ
PUSH1 0x94
...
//@note 0x94 [updateHorseNumber_index_1_6]
JUMPDEST
POP
JUMP

//@note 0x97 [updateHorseNumber_index_1_2]
JUMPDEST      // top [0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
PUSH0         // top [0x00 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
DUP2          // top [0x04 0x00 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
CALLDATALOAD  // top [calldata 0x04 0x00 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
SWAP1         // top [0x04 calldata 0x00 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
POP           // top [calldata 0x00 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
PUSH1 0xa3    // top [0xa3 calldata 0x00 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
DUP2          // top [calldata 0xa3 calldata 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
PUSH1 0x84    
JUMP

//@note 0xa3 [updateHorseNumber_index_1_7]
JUMPDEST
SWAP3
SWAP2
POP
...
PUSH1 0xc6    // top [0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
DUP5          // top [cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
DUP3          // top [0x00 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
DUP6          // top [0x04 0x00 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
ADD           // top [0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
PUSH1 0x97    // top [0x97 0x04 cds 0xc6 0x00 0x00 0x04 cds 0x46 0x4a selector] bottom
JUMP          //@note jump[updateHorseNumber_index_1_2]

//@note 0xc6 [updateHorseNumber_index_1_8]
JUMPDEST
SWAP2
POP
POP
